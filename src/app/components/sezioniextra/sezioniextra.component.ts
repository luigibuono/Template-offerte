...
@Component({
  selector: 'app-sezioniextra',
  templateUrl: './sezioniextra.component.html',
  styleUrls: ['./sezioniextra.component.css']
})
export class SezioniextraComponent implements OnInit {
  dati: any[] = [];
